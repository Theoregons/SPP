...
,
								...
								<h3> <b>Info Pembayaran Ujian ( UAS & UTS )</b> </h3><br>
								<a href = "form_TUAS">
									<button class = "btn btn-primary">
										<i class = "fa fa-plus"> </i> &nbsp Tambah Data Ujian &nbsp 
									</button>
								</a> <br><br>
								<div class="center">
									...
									<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php echo anchor('SPP/edit_uas/'. $th->id_academic,'
																<div class="green">
														...
														<td onclick="javascript: return confirm('r u sure ?')">
															<?php echo anchor('SPP/hapusuas/'.$th->id_academic, '<div class="red" >
