						...
						<div class="login-container"><br><Br><br><br><br>
							<div class="center">
								<h1>
									...
									<span class="red">SPP</span>
									<span class="white" id="id-text2">Application</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; MI KH. Mohammad Said</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo site_url('SPP/ceklogin')?>" method="post" >

												<fieldset>
													 <?php $info = $this->session->flashdata('info'); if (!empty($info)){ echo $info; } ?>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-35 pull-mid btn btn-sm btn-primary">
