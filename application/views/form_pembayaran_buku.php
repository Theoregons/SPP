								...
								<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="country"> <?php echo $td->school ?> </span>
					...
					<!-- /.page-content -->
						...
						<div class="row">
							<div class="col-xs-8">
								...
								<h3> <b>Form Pembayaran Buku</b> </h3><br>
								<div class="center">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<form method="post" action="<?php echo base_url().'SPP/bayar_buku'; ?>">
																...
																<div class="form-group">
																	<input type="hidden" name="jenis" class="form-control"value = "<?php echo $uj->jenis ?>">
																</div>
																
																<div class="form-group">
																	<input type="hidden" name="claim" class="form-control" value = <?php echo $uj->claim ?>>
																</div>
																...
																<div class="form-group">
																	<input type="hidden" name="name" class="form-control" value = "<?php echo $detail->name ?>" >
																  	...
																  	<?php echo anchor('SPP/bayar_buku/'.$detail->nis,'<td><button class="btn btn-xs btn-success pull-mid">
