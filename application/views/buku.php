...
,
								...
								<a href = "form_TBuku">
									<button class = "btn btn-primary">
										<i class = "fa fa-plus"> </i> &nbsp Tambah Jenis Buku &nbsp 
									</button>
								</a> <br><br>
								<div class="center">
									...
									<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php echo anchor('SPP/edit_book/'.$th->id,'
																<div class="green">
														...
														<td onclick="javascript: return confirm('r u sure ?')">
															<?php echo anchor('SPP/hapusbook/'.$th->id, '<div class="red" >
