...
,
								...
								<h3> <b>Form Data Siswa</b> </h3><br>
								<a href = "form_TS">
									<button class = "btn btn-primary">
										<i class = "fa fa-plus"> </i> &nbsp Tambah Data Siswa&nbsp 
									</button>
								</a> &nbsp;&nbsp;
								<a href = "<?php echo base_url('SPP/excelsiswa') ?>">
									<button class = "btn btn-primary">
										<i class = "fa fa-plus"> </i>
										
										&nbsp Backup Data Siswa  (Export to Excel)&nbsp 
									</button>
								</a>
								<br/><br/>
								<div class="center">
									...
									<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php echo anchor('SPP/edit/'.$DS->nis, '
																<div class="blue">
														...
														<td onclick="javascript: return confirm('r u sure ?')">
															<?php echo anchor('SPP/hapus/'.$DS->nis, '<div class="red" >
