...
,
								...
								<a href = "<?php echo base_url('SPP/excelbook') ?>">
									<button class = "btn btn-primary">
										<i class = "fa fa-plus"> </i>
										
										&nbsp Backup Data Pembayaran Buku (Export to Excel) &nbsp 
									</button>
								</a> <br><br>
								<div class="center">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<td>
																<li>
																	<a class="btn btn-xs btn-success pull-mid" href = "<?php echo base_url(),'SPP/cetakbuku/'.$DS->id_payment ?>"><span class="bigger-110">Cetak</span></a>
															  	</li>
															</td>
